...
pkgs.stdenv.mkDerivation {
  ...
  buildPhase = ''
    ...
    hugo_required_files=(
      ...
      "assets/css/semantic/_tokens.scss"
      "assets/css/semantic/_base.scss"
      "assets/css/semantic/_layout.scss"
      "assets/css/semantic/_images.scss"
      "assets/css/semantic/_blocks.scss"
      "assets/css/semantic/_code.scss"
      "static/.keep"
      "scripts/site.py"
